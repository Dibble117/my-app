...
const BookingForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Set the formSubmitted state to true to show the success message
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {formSubmitted && (
        <p style={{ color: 'lightblue', marginTop: '16px' }}>Booking successful! We look forward to hosting you.</p>
      )}
    </form>
  );
};
